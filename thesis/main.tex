...
\include{text/terminology}

\include{text/interaction_evaluation}

\include{text/ti_aggregation}

\include{text/recommendations}

\include{text/computational_model}

\include{text/simulations}

\include{text/equations}

...
The peer can provide essentially any score but with very low confidence in said score. That's why the $\mu^{up}_{s}$ is quite high whereas the mean for this behavior is $0$.

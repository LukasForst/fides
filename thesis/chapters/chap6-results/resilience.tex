...
The same applies for all other interaction evaluation methods as we can see on the figure~\ref{fig:performance-all-setups-25-pretrusted} that in the most hard environment, they all classified the targets poorly with all threat intelligence aggregation methods.

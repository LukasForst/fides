...
Similarly, as in the previous section (\ref{subsec:exploring-interaction-eval-strategies}), threat intelligence aggregation methods explored in this thesis, described in section \ref{sec:threat-intelligence}, do not use any other information than ones provided by the network at a single time window.

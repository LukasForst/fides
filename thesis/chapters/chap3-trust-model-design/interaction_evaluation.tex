...
The value itself is loaded from the configuration provided by the administrator. We denote it as $S_{C}$. 
...
\noindent
This strategy is implemented in Fides under a name $MaxConfidenceTIEvaluation$.

\todo[inline]{add here diagram from Miro "Satisfaction on an Interaction"}
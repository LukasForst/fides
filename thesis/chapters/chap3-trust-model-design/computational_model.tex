...
\todo[inline]{We need to justify why this Integrity belief. Is it in SORT? if yes just reference. If not, then we need to justify why is not like a normal stdev. Is the more weird for me}

...
This strategy uses the very same equation~\ref{eq:ti_aggregation_score} to compute aggregated score $S^{k}_{T}$ as $AverageConfidenceTIAggregation$~\ref{subsec:AverageConfidenceTIAggregation}.
